...
func (c Core) ListObjectVersion(bucket, prefix, keyMarker, versionIDMarker, delimiter string, maxkeys int, fetchDelete bool) (ListVersionsResult, error) {
	return c.listObjectVersionsQuery(context.Background(), bucket, prefix, keyMarker, versionIDMarker, delimiter, maxkeys, fetchDelete, http.Header{})
}
...
func (c Core) ListObjectsV2(bucketName, objectPrefix, startAfter, continuationToken, delimiter string, maxkeys int, FetchDelete bool) (ListBucketV2Result, error) {
	return c.listObjectsV2Query(context.Background(), bucketName, objectPrefix, continuationToken, true, false, delimiter, startAfter, maxkeys, FetchDelete, nil)
}
